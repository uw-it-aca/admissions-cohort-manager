...
class AssignmentImport(models.Model):
    ...
    FIELD_SYSTEM_KEY = 'SDB Src System Key'
    FIELD_APPLICATION_NUMBER = 'Application Nbr'
    FIELD_GENDER = 'Gender'
    FIELD_UNDERREP_MINORITY = 'Underrepresented Minority Desc'
    FIELD_IPEDS_RACE = 'IPEDS Race Ethnicity Category'
    FIELD_RESIDENT_GROUP = 'Resident Group'
    FIELD_COHORT = 'SDB Cohort'
    FIELD_APPLICATION_STATUS = 'SDB Application Status'
    FIELD_HS_GPA = 'High School GPA'
    FIELD_LOW_INCOME = 'LowFamilyIncomeInd'
    FIELD_FIRST_GEN = 'First Generation Ind'
    FIELD_ATHLETE_CODE = 'Athlete Code'
    ...
    FIELD_FR_ADMISSIONS_RECOM = 'FR Admissions Recommendation'
    FIELD_FR_ACADEMIC = 'FR Academic'
    FIELD_FRPQA = 'Frpqa'
    ...
    FIELD_MATH_LEVEL = 'Math Level Code'
    FIELD_REASON = 'ReasonCode'
    FIELD_LAST_SCHOOL_CODE = 'Last School Code'
    FIELD_LAST_SCHOOL_NAME = 'Last School Name'
    FIELD_HS_CODE = 'HighSchoolCode'
    FIELD_HS_NAME = 'HighSchoolName'
    FIELD_HS_CITY = 'High School City'
    FIELD_HS_STATE = 'High School State'
    FIELD_HS_FRL_PCT = 'High School FRL Pct'
    FIELD_ASSIGNED_COHORT = 'Assigned Cohort'
    FIELD_ASSIGNED_MAJOR_CODE = 'Ad Sel Assigned Major Program Code'
    FIELD_HIGHEST_CONCORDED_SAT_MATH = 'Highest Concorded SAT Math'
    FIELD_ADSEL_ID = 'Admissions Selection Id'
    FIELD_EMPTY = ''
